...
PM_START_TEXT = """
Hello there, I'm [Rashmika](https://telegra.ph/file/e89f39c1af4f16243d451.jpg)

I am an 𝐴𝑛𝑖𝑚𝑒 Themed Group Managing Bot and I will help in managing your group with love
...
But my creator is a kanger, so no need of donation kek"""
...
def DaisyX_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text=f"*😍 Hi again!  The name's {dispatcher.bot.first_name} 😍 \n\nAs  You I'm a next gen group management bot developed by a Kanger.* "
            f"\n\n 🔥 Search Github To Keep Yourself Updated About {dispatcher.bot.first_name} 🔥"
            f"\n\n I have the normal GROUP MANAGING functions like flood control, a warning system etc but I mainly have the advanced and handy Antispam system and the SIBYL banning system which safegaurds and helps your group from spammers."
            f"\n\nI Can Manage Your Groups Smoothly, With Some Special Features [:)](https://telegra.ph/file/e89f39c1af4f16243d451.jpg)"
        ...
        query.message.edit_text(
            ...
            f"\n\nYou Can get support {dispatcher.bot.first_name} by searching on Ghub.\n"
            f"",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
